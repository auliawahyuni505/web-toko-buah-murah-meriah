...
?>
	<div class="judul">
		<h1><p align="center">Edit Data Transaksi</p></h1>
	</div>
	</br>
</br>
	
<form class="form-horizontal" action="update-transaksi.php" method="post">
<table>
<div class="row">
	...
	$query_mysql=mysql_query("SELECT * FROM tb_transaksi WHERE kd_transaksi='$kd_transaksi'")or data(mysql_error());
	$nomor=1;
	...
	<div class="form-group">
		<label class="col-sm-4 control-label">Nama Pelanggan</label>
			...
			<input type="hidden" name="kd_transaksi" value="<?php echo $data['kd_transaksi'] ?>">
				<select name="id_pelanggan" class="form-control" value="<?php echo $data['id_pelanggan'] ?>">
